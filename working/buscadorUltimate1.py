...
class FileSearchExplorer:
    def __init__(self, master):
        ...
        self.update_system_info()  # Actualiza la info del sistema cada 5 segundos
    ...
    def update_system_info(self):
        ...
        print("Actualización de información del sistema:")
        for line in info:
            print(line)
    ...
    def get_system_info(self):
        ...
        if CPU_INFO_AVAILABLE:
            try:
                ...
                info.append(f"Procesador: {cpu_info.get('brand_raw', 'N/A')}")
            except Exception:
                info.append("Información de CPU no disponible")
        try:
            messagebox.showinfo(¨Informacion del sistema¨, "\n".join(info))